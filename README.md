...
> Visite a página clicando [aqui](https://zkd-calculadora.netlify.app/ "Visitar página").

### Sobre o projeto:

Nesse projeto foi criado uma **Calculadora** que resolve contas **Aritméticas**, no caso: _Multiplicação_, _Divisão_, _Adição_ e _Subtração_. 
Caso ainda não tenha visto a página, clique [aqui](https://zkd-calculadora.netlify.app/ "Visitar página").
